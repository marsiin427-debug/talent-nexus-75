  ...
  head: () => ({
    meta: [
      ...
      { title: "ManpowerX — Verified foreign employment demands from Nepal" },
      {
        name: "description",
        content:
          "Live labour demands published by licensed Nepali manpower agencies — salary, seats, facilities and deadlines at a glance.",
      },
      { name: "author", content: "ManpowerX" },
      { property: "og:site_name", content: "ManpowerX" },
